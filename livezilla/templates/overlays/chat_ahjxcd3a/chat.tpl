        ...
        <div id="lz_chat_data_form" class="lz_chat_module">
            ...
            <div id="lz_chat_data_form_inputs">
                <div>
                    ...
                    <br>
                    <div id="lz_chat_overlay_data_form_ok_button" class="lz_overlay_chat_button lz_chat_unselectable lz_overlay_br_five" style="background:<!--sc-->;" onclick="lz_chat_data_form_result();"></div>
                </div>
            </div>
        </div>
