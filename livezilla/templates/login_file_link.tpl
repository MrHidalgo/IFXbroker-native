...
<table id="lz_form_<!--name-->" class="lz_input">
	<tr>
		<td>
            <div class="lz_form_base lz_form_box" onclick="lz_chat_switch_options('fu',false,'ticket',<!--name-->);" style="text-align: right;cursor:pointer;">
                <span id="lz_form_caption_<!--name-->" class="lz_form_file_caption"><!--caption_plain--></span>
                <span>
                    <span name="form_sc_<!--name-->" onclick="event.stopPropagation();OverlayChatWidgetV2.CaptureScreen();" class="lz_form_file_add"><!--lz_chat_sc--></span>
