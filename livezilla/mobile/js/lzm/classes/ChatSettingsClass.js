        ...
        if (table == 'ticket' && columnArray instanceof Array) {
            if (columnArray instanceof Array && columnArray.length == 0)
            {
                newColumnArray = [
                    ...
                    {cid: 'source_type', title: 'Source', display: 1, sort_key:'source_type',cell_id: 'ticket-sort-source-type', cell_class: 'ticket-list-sort-column', cell_style: 'cursor: pointer;', cell_onclick: 'sortTicketsBy(\'source_type\');'},
                    {cid: 'sub_source', title: 'Sub-Source', display: 0, sort_key:'sub_source', cell_id: 'ticket-sort-sub-source', cell_class: 'ticket-list-sort-column', cell_style: 'cursor: pointer;', cell_onclick: 'sortTicketsBy(\'sub_source\');'},
        ...
        else if (table == 'archive' && columnArray instanceof Array)
        {
            if (columnArray instanceof Array && columnArray.length == 0)
            {
                newColumnArray = [
                    ...
                    {index: 21, cid: 'tags', title: 'Tags', display: 1}
                ];
                LocalConfiguration.AddCustomBlock(newColumnArray);
            }
        }
