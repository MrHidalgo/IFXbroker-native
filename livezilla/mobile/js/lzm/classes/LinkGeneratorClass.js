...
LinkGeneratorClass.prototype.GetCodeWrapper = function(){
    ...
    html += '<!-- livezilla.net PLACE SOMEWHERE IN BODY -->\r\n<script type="text/javascript" id="' + this.m_CurrentCodeId +'" src="'+DataEngine.getServerUrl('script.php',this.GetSelectedScheme())+'?id=' + this.m_CurrentCodeId +'" defer></script>\r\n<!-- livezilla.net PLACE SOMEWHERE IN BODY -->';
    ...
    this.m_Settings = [
        ...
        {name:'Dimensions', title: t('Dimensions'), groups: [
            ...
            {name: 'Icon Size', title: 'Icons', controls: [
                {name:'m_IconSize', type:'array', value: '1', options: [{value: 0.8, text: tid('very_small')},{value: 1, text: tid("small")},{value: 1.2, text: tid('medium')},{value: 1.4, text: tid('large')}]}
...
LinkGeneratorClass.CreateDefaultButton = function(){
    lzm_commonDialog.createAlertDialog(tid('create_default_button'), [{id: 'yes', name: tid('yes')},{id: 'no', name: tid('no')}],true,true,false);
