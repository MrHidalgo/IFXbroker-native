...
ChatVisitorClass.prototype.CreateCoBrowsingTab = function(_visitorObj,elementId){
    ...
    if (d(_visitorObj.b) && _visitorObj.is_active)
    {
        ...
        coBrowseHtml = '<div class="lzm-fieldset top-space" id="visitor-cobrowse-'+elementId+'"><div id="visitor-cobrowse-'+elementId+'-inner"><div><select id="visitor-cobrowse-'+elementId+'-browser-select" class="lzm-select" data-role="none">';
