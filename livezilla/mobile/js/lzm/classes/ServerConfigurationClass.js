    ...
    this.m_Settings = [
        ...
        {name:'KnowledgeBase', title: tid('knowledgebase'),icon:'life-ring', groups: [
            ...
            {name: 'KBTemplate', title: 'Template', controls: [
                {name:'gl_kbdc', standard: true, type:'color', value: '#4078c7', title: tidc('primary_color'), top:'double'}
            ], custom:true},
        ...
        {name:'Translation', title: tid('translation'), icon:'language', groups: [
            {name: 'General', title: tid('general'), controls: [
                ...
                {name:'gl_on_def_lang', standard:true, type:'bool', value: 0, top:'single', title: tid('ignore_translations')}
            ]},
...
ServerConfiguration.prototype.ApplyLogicToForm = function() {
    ...
    setTimeout(function(){applyWaitingTimeLogic();},500);
    ...
    // translations
    $('#cb-gl_on_def_lang').change(function(){
        if(!$('#cb-gl_on_def_lang').prop('checked'))
            $('#cb-gl_dsbl').parent().removeClass('ui-disabled');
        else
            $('#cb-gl_dsbl').parent().addClass('ui-disabled');
    });
    $('#cb-gl_on_def_lang').change();
